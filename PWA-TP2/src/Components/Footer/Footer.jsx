...
export default function Footer({
    ...
    return (
        <footer className="bg-gray-200 md:rounded-none rounded-xl p-4 sm:p-6  border-t border-gray-300 pt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
